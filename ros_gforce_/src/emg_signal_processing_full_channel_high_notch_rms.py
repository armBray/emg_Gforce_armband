...
sos1 = signal.butter(2, f0/fs*2, output='sos')              #notch
high = signal.butter(2, f1/fs*2, 'hp', fs=650, output='sos')  #high
...
def callback(data):
    ...
    for i in range(len(data.data)):
        ...
        notch = iir1.filter(high_pass)
        abs_square = abs(notch) * abs(notch)
