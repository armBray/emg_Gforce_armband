...
print(U_Offline_T)
print("U_Offline: ",U_Offline_T.shape)
plt.figure()
plt.suptitle('U')
plt.plot(time_t, U_Offline_T)
...
print("cc_level.shape: ", cc_level_min)
...
write_cc = {"cc_level_min": cc_level_min, "cc_level_max": cc_level_max}
